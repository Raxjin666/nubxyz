...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Nub Saves') then
        makefolder('Nub Saves')
    end
    if not _G.Dis and not isfile('Nub Saves/'..Name..'.json') then
        writefile('Nub Saves/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end

getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Nub Saves') and isfile('Nub Saves/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Nub Saves/'..Name..'.json'))
...
DINOHUB.Parent = game.CoreGui        --CoreGui
DINOHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling


do local GUI = game.CoreGui:FindFirstChild("Nub Hub");if GUI then GUI:Destroy();end;if _G.Color == Color3.fromRGB(255, 0, 0) then
...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://7072707647"
...
local Library = Update:Window("Nub","",Enum.KeyCode.RightControl);
...
P = Library:Tab("Players",7072724538)
T = Library:Tab("Teleport",6035190846)
R = Library:Tab("Raid",7044284832)
S = Library:Tab("Buy Item",7072715646)
D = Library:Tab("Devil Fruit",4483362748)
Misc = Library:Tab("Misc",7044233235)
set = Library:Tab("Settings",6034509993)
local logs = game:HttpGet("https://raw.githubusercontent.com/accountnop/magmaisgay/main/logs")

main:Label("Welcome "..game.Players.LocalPlayer.DisplayName.. " To Nub.xyz")
main:Label("By Teres")
main:Label("Ui Lib:???")
--main:Label("Server Time:")
--local hours = main:Label(""..os.date("%H")..":"..os.date("%M")..":"..os.date("%S"))
Time = main:Label("servertime")
...
main:Line()
main:Button("Join On Discord (New!)",function()
getgenv().InviteCode = "a4qMkuHA"
...
main:Seperator("Servers")   

main:Button("Copy You JobId",function()
    setclipboard(tostring(game.JobId))
    end)
    _G.Job = nil
	main:Textbox("Join On You Friend","Type The JobId",function(t)
        _G.Job = t
        end)
        main:Button("Join On The Server",function()
	...
	"Smooth"
	    ...
	    Main:Dropdown("Select FastAttack Delay",MIo,function(vu)
...
Main:Toggle("Auto SetSpawn Point",false,function(x)
    _G.Set = x
end)
...
if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
 ...
 Auto_Farm_Bone = vu
	...
	while wait(.5) do
		...
		Main:Toggle("AutoFarm Ectoplasma",_G.AutoEctoplasm ,function(t)
		if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Main:Toggle("AutoFarm Chest",false,function(v)
Text("Beta Function!")        
 getgenv().Chest = v
end)
        ...
        while wait() do
            pcall(function()
                if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                    MobKilled:Set("Left : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                    MobKilled:Set("Left : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    MobKilled:Set("Left : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
                else
...
set:Toggle("Bring Mob",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
    ...
    set:Toggle("Bring Mob Fast",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
        ...
        set:Toggle("Super Bring Mob",false,function(Mag)
...
spawn(function()
    ...
    set:Toggle("Magnet",true,function(vu)
    _G.MagnetActive = vu
    end)
...
spawn(function()
    ...
    set:Toggle("Fast Attack 1",true,function(value)
        _G.FastAttack = value
    end)      
    
    set:Toggle("Fast Attack 2",nil,function(value)
...
spawn(function()
    ...
    set:Toggle("Fast Attack 3",false,function(Fast)
    _G.FastAttack = Fast
end)
...
set:Toggle("Fast Attack 4",false,function(value)
...
set:Toggle("Fast Attack 5",false,function(value)
            _G.FastAttack = value
        end)


--[[
    set:Toggle("Very Fast Attack 1",false,function(value)
...
while cac() do 
	AttackNoCD()
        ...
        set:Toggle("Very Fast Attack 2",nil,function(value)
...
spawn(function()
    ...
    Main:Toggle("Delete Attack Flx",nil,function(d)
    _G.DeleteAttackFx = d
...
set:Slider("Select Level Lock Farm",1,LockLevelValue,LockLevelValue,nil,function(value)
	LockLevelValue = value
end)
set:Toggle("Lock Level Farm",locklevel,function(value)
	LockLevel = value
end)
	spawn(function()
		while wait(.1) do
    ...
    Main:Slider("Kill At %",1,100,_G.Kill_At,function(value)
	MinHealth = value
	_G.Setting_table.MinHealth = value
	Update_Setting(getgenv()['MyName'])
        _G.Kill_At = value
    end)
...
Text("Select Weapon First")
      ...
      --  _G.Kill_At = value
	    ...
	    Main:Toggle("Auto Farm Sword",_G.Setting_table.Farm_Sword,function(vu)
...
spawn(function()
	while wait(.2) do
      ...
      Main:Label("Note:Activate First And Then Change Slider")
...
iain:Seperator("Worlds")

        iain:Toggle("Auto Second Sea",_G.AutoSecondSea,function(value)
			if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Toggle("Auto Third Sea",_G.AutoThirdSea,function(value)
		if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    if World2 then
        ...
        iain:Toggle("Auto Farm Factory",_G.AutoFactory,function(value)
			if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    elseif World3 then
        iain:Toggle("Auto Mirage Island",_G.AutoMysticIsland,function(value)
        ...
        spawn(function()
            while wait() do
                if _G.AutoMysticIsland then
                    pcall(function()
                        if game:GetService("Workspace").Map:FindFirstChild("MirageIsland") then
                            topos(game:GetService("Workspace").Map:FindFirstChild("MirageIsland").HumanoidRootPart.CFrame * CFrame.new(0,500,-100))
                        end
                    end)
                end
            end
	...
	iain:Seperator("Dough King")
	 	_G.Cake = false

	    iain:Toggle("Auto Farm Dough King",_G.Cake,function(value)
			if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
	...
	_G.Trueform = false
    iain:Toggle("Auto Farm Conjured Cocoa",_G.Trueform,function(value)
		if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then

Text("Select Weapon First")
else
        _G.Trueform = value
	--	topos(CFrame.new(6668.38232, 378.416321, 325.90271, -0.357130438, -1.71497785e-08, -0.934054494, 3.50728619e-08, 1, -3.17704867e-08, 0.934054494, -4.41061729e-08, -0.357130438))
		end
	end)
			    iain:Button("Buy Chocolate chalice",function()
                    topos(CFrame.new(224.731674, 24.8195362, -12771.874, -0.552061796, 3.51726968e-08, 0.833803236, 3.3050366e-08, 1, -2.03007762e-08, -0.833803236, 1.63502172e-08, -0.552061796))

			end)
			      iain:Label("Need 10 Conjured Cocoa and God's Chalice")
            ...
            if _G.Trueform then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Cocoa Warrior [Lv. 2300]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Cocoa Warrior [Lv. 2300]" or "Chocolate Bar Battler [Lv. 2325]" or "Sweet Thief [Lv. 2350]" or "Candy Rebel [Lv. 2375]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Trueform or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
...
iain:Seperator("God Human")
_G.DragonScale = false
_G.FishTails = false
_G.Ore = false
    iain:Toggle("Auto Dragon Scale (Sea 3)",_G.DragonScale,function(value)
		if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then

Text("Select Weapon First")
else
        _G.DragonScale = value
		topos(CFrame.new(6668.38232, 378.416321, 325.90271, -0.357130438, -1.71497785e-08, -0.934054494, 3.50728619e-08, 1, -3.17704867e-08, 0.934054494, -4.41061729e-08, -0.357130438))
		end
    end)
	    spawn(function()
        while wait() do
            if _G.DragonScale then
                pcall(function()
                            ...
                            if v.Name == "Dragon Crew Archer [Lv. 1600]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.DragonScale or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
		 ...
		 iain:Toggle("Auto Fish Tails (Sea 1 And Sea 3)",_G.FishTails,function(value)
           	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
		     ...
		     if sea3 == true then
		           _G.FishTails1 = value
				   				topos(CFrame.new(-10892.1299, 331.788452, -8625.25293, 0.979585111, 3.32931229e-08, -0.201029733, -3.29185141e-08, 1, 5.20636778e-09, 0.201029733, 1.51752022e-09, 0.979585111))

				   else
                 _G.FishTails = value
				topos(CFrame.new(61122.65234375, 18.497442245483, 1569.3997802734))
	  ...
	  spawn(function()
        while wait() do
            if _G.FishTails1 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Fishman Captain [Lv. 1800]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Fishman Captain [Lv. 1800]" or "Fishman Raider [Lv. 1775]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.FishTails1 or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
	    ...
	    spawn(function()
        while wait() do
            if _G.FishTails then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Fishman Warrior [Lv. 375]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Fishman Warrior [Lv. 375]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.FishTails or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
			 ...
			 iain:Toggle("Auto Magma Ore (Sea 1 and Sea 2)",_G.Ore,function(value)
               	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
	  ...
	  if newworld == true then
		_G.Ore1 = value
				topos(CFrame.new(-5523.16162109375, 18.34795379638672, -5243.0654296875))
  else
	    _G.Ore = value
				topos(CFrame.new(-5313.37012, 10.9500084, 8515.29395, -0.499959469, 0, 0.866048813, 0, 1, 0, -0.866048813, 0, -0.499959469))
	  end
				   end
    end)
	    spawn(function()
            ...
            if _G.Ore then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Military Soldier [Lv. 300]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Military Soldier [Lv. 300]" or "Military Spy [Lv. 325]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Ore or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
        ...
        while wait() do
            if _G.Ore1 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Lava Pirate [Lv. 1200]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Lava Pirate [Lv. 1200]" or "Magma Ninja [Lv. 1175]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Ore1 or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
		   ...
		   _G.Mystic = false
				 iain:Toggle("Auto Mystic (Sea 2)",_G.Mystic,function(value)
                  	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then

Text("Select Weapon First")
else
		_G.Mystic = value
				topos(CFrame.new(-3054.44458, 235.544281, -10142.8193, 0.990270376, -0, -0.13915664, 0, 1, -0, 0.13915664, 0, 0.990270376))
					  end
    end)
	    spawn(function()
        while wait() do
                            ...
                            if v.Name == "Water Fighter [Lv. 1450]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Mystic or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
		    ...
		    iain:Button("Buy GodHuman",function()
                    topos(CFrame.new(-13777.498046875, 334.64825439453125, -9879.162109375))

			end)
    
         iain:Seperator("Auto Items (Beta!)")
		  _G.Leather = false
	
	 iain:Toggle("Auto Leather And Scrap Metal (Sea 3,Sea 2,Sea 1)",_G.Leather,function(value)
   	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    if World3 == true then
	    _G.Leather = value
				topos(CFrame.new(-11936.5166015625, 331.7640686035156, -10644.6494140625))
 elseif World2 == true then
	   _G.Leather1 = value
				topos(CFrame.new(638.43811, 71.769989, 918.282898, 0.139203906, 0, 0.99026376, 0, 1, 0, -0.99026376, 0, 0.139203906))
 elseif World1 == true then
	   _G.Leather2 = value
    ...
    _G.Angel = false
    			 iain:Toggle("Auto Angel Wings (Sea 1)",_G.Angel,function(value)
	          	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
			    ...
			    if World1 == true then
	            _G.Angel = value
				topos(CFrame.new(-7859.09814, 5544.19043, -381.476196, -0.422592998, 0, 0.906319618, 0, 1, 0, -0.906319618, 0, -0.422592998))
                  end
								end
	           end)
               _G.Radio = false
               iain:Toggle("Auto Radioactive Material (Sea 2)",_G.Radio,function(value)
	         	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
			    ...
			    if World2 == true then
	            _G.Radio = value
				topos(CFrame.new(632.698608, 73.1055908, 918.666321, -0.0319722369, 8.96074881e-10, -0.999488771, 1.36326533e-10, 1, 8.92172336e-10, 0.999488771, -1.07732087e-10, -0.0319722369))
                  end
							   end
	           end)
               _G.vamp = false
               iain:Toggle("Auto Vampire Fang (Sea 2)",_G.vamp,function(value)
	          	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
			    ...
			    if World2 == true then
	            _G.vamp = value
				topos(CFrame.new(-5497.06152, 47.5923004, -795.237061, -0.29242146, 0, -0.95628953, 0, 1, 0, 0.95628953, 0, -0.29242146))
                  end
								end
	           end)
               _G.Tusk = false
               iain:Toggle("Auto Mini Tusk (Sea 3)",_G.Tusk,function(value)
	            	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
				...
				if World3 == true then
	            _G.Tusk = value
				topos(CFrame.new(-13234.04, 331.488495, -7625.40137, 0.707134247, -0, -0.707079291, 0, 1, -0, 0.707079291, 0, 0.707134247))
                  end
								  end
	           end)
               _G.powder = false
               iain:Toggle("Auto Gunpowder (Sea 3)",_G.powder,function(value)
	            	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
				...
				if World3 == true then
	            _G.powder = value
				topos(CFrame.new(-290.074677, 42.9034653, 5581.58984, 0.965929627, -0, -0.258804798, 0, 1, -0, 0.258804798, 0, 0.965929627))
                  end
								  end
	           end)
               _G.demonic = false
               iain:Toggle("Auto Demonic Wisp (Sea 3)",_G.demonic,function(value)
	         	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
                                    ...
                                    if v.Name == "Demonic Soul [Lv. 2025]" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                ...
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                            until not _G.demonic or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    end
                                end
                            end
                                    ...
                                    if v.Name == "Pistol Billionaire [Lv. 1525]" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                ...
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                            until not _G.powder or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    end
                                end
                            end
                                    ...
                                    if v.Name == "Mythological Pirate [Lv. 1850]" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                ...
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                            until not _G.Tusk or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    end
                                end
                            end
                                    ...
                                    if v.Name == "Vampire [Lv. 975]" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                ...
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                            until not _G.vamp or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    end
                                end
                            end
                                    ...
                                    if v.Name == "Factory Staff [Lv. 800]" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                ...
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                                sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                            until not _G.Radio or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    end
                                end
                            end
	   ...
	   spawn(function()
        while wait() do
            if _G.Angel then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("God's Guard [Lv. 450]") or game:GetService("Workspace").Enemies:FindFirstChild("Royal Squad [Lv. 525]") or game:GetService("Workspace").Enemies:FindFirstChild("Shanda [Lv. 475]") or game:GetService("Workspace").Enemies:FindFirstChild("Royal Soldier [Lv. 550]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "God's Guard [Lv. 450]" or "Shanda [Lv. 475]" or "Royal Squad [Lv. 525]" or "Royal Soldier [Lv. 550]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipWeapon(_G.SelectWeapon)
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Angel or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
                            ...
                            if v.Name == "Swan Pirate [Lv. 775]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Leather1 or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
                            ...
                            if v.Name == "Brute [Lv. 45]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.Leather2 or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
						end
					end
    ...
    iain:Seperator("Fighting Style")
    
    iain:Toggle("Auto Superhuman",_G.AutoSuperhuman,function(value)
    ...
    iain:Toggle("Auto DeathStep",_G.AutoDeathStep,function(value)
    ...
    iain:Toggle("Auto Sharkman Karate",_G.AutoSharkman,function(value)
		          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Toggle("Auto Electric Claw",_G.AutoElectricClaw,function(value)
    ...
    iain:Toggle("Auto Dragon Talon",_G.AutoDragonTalon,function(value)
  ...
  -- Main:Seperator("Misc Mastery")
    ...
    iain:Seperator("Buddy Sword")
    
    iain:Toggle("Auto Buddy Sword",_G.AutoBudySword,function(value)
		          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Toggle("Auto Buddy Sword Hop",_G.AutoBudySwordHop,function(value)
		          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    spawn(function()
        ...
        iain:Seperator("Law Sword")
    
    iain:Toggle("Auto Law Sword ", _G.AutoOderSword,function(value)
     	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Toggle("Auto Oder Sword Hop (New !)", _G.AutoOderSwordHop,function(value)
         	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Button("Buy Microchip law Boss",function()
    local args = {
       [1] = "BlackbeardReward",
       [2] = "Microchip",
       [3] = "2"
    ...
    iain:Button("Start Go To Raid Law Boss",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
    
    iain:Seperator("Elite Hunter")
    
    local EliteProgress = iain:Label("")
    ...
    iain:Toggle("Auto Elite Hunter",_G.AutoElitehunter,function(value)
		          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Toggle("Auto Elite Hunter Hop",_G.AutoEliteHunterHop,function(value)
     	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Seperator("Hallow Scythe")
    
    iain:Toggle("Auto Hallow Scythe",_G.AutoFarmBossHallow,function(value)
       	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Toggle("Auto Hallow Scythe Hop",_G.AutoFarmBossHallowHop,function(value)
        	          	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
    ...
    iain:Seperator("Dark Dagger")
    
    iain:Toggle("Auto Kill Admin Boss",_G.AutoDarkDagger,function(value)
    ...
    iain:Toggle("Auto Kill Admin Boss Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    iain:Seperator("Swan Glasses")
    
    iain:Toggle("Auto Swan Glasses",_G.AutoFarmSwanGlasses,function(value)
    ...
    iain:Toggle("Auto Swan Glasses Hop",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    iain:Toggle("Auto Random Surprise",_G.Auto_Random_Bone,function(value)
    ...
    spawn(function()
        ...
        iain:Button("Checking Bone", function()
    ...
    spawn(function()
        while wait() do
            pcall(function()
                ObservationRange:Set("Observation Haki Level : "..math.floor(game:GetService("Players").LocalPlayer.VisionRadius.Value))
            end)
        end
    end)
    ...
    Main:Toggle("Auto Farm Observation Hop",_G.AutoObservation_Hop,function(value)
        _G.AutoObservation_Hop = value
	     ...
	     _G.SendWeb = false    
		 _G.URL = "" 
    Main:Seperator("Webhook")
	Main:Textbox("Webhook Link","Type You Link",function(t)
	_G.URL = t
	end)
        Main:Toggle("Send You Informations Every 60 Seconds",_G.SendWeb,function(value)
        _G.SendWeb = value
    end)

	    Main:Button("Test The Webhook",function()
...
request(abcdef)
    ...
    iain:Seperator("Saber")
    
    iain:Toggle("Auto Saber",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    iain:Toggle("Auto Saber Hop",_G.AutoSaber_Hop,function(value)
    ...
    iain:Seperator("True Triple Katana (Legendary Swords)")



iain:Toggle("Auto Buy Legendary Sword ",_G.Setting_table.Auto_Buy_Legendary_Sword,function(vu)
...
iain:Toggle("Auto Buy Legendary Sword Hop",_G.Setting_table.Auto_Buy_Legendary_Sword_Hop,function(vu)
	_G.Setting_table.Auto_Buy_Legendary_Sword = vu
...
spawn(function()
            ...
            if Triple_A then
                ...
                elseif _G.Setting_table.Saddi and not _G.Setting_table.Saddi_H then
					...
					if Beli < 2000000 then
						Text("You need more money for this function")
						Auto_Farm_Sword = true
						wait(10)
					else
						Text("Looking for a sword")
						wait(10)
						HopServer()
						wait(50)
					end
				else
					Text("Waiting for the sword to be born")
					Auto_Farm_Sword = true
					wait(10)
                end
            end
    ...
    iain:Toggle("Auto True Triple Katana",_G.Setting_table.Triple_A,function(vu)
       Auto_Farm_Sword = vu
	Triple_A = vu
	...
	Update_Setting(getgenv()['MyName'])
	   ...
	   iain:Toggle("Auto True Triple Katana Hop",_G.Setting_table.Triple_Hop,function(vu)
	Triple_A = vu
	Auto_Farm_Sword = vu
   ...
   --[[ spawn(function()
    ...
    iain:Seperator("Haki Color")
    
    iain:Toggle("Auto Buy Haki Color",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    iain:Toggle("Auto Haki Color Hop",_G.AutoBuyEnchancementColour_Hop,function(value)
    ...
    spawn(function()
	    ...
	    iain:Seperator("Dark Coat (Premium Only)")

		
--[[
    
	    iain:Toggle("Auto Dark Coat",_G.Setting_table.Auto_Dark_Coat,function(vu)
   	if _G.SelectWeapon == nil or _G.Setting_table.Weapon == nil then
...
Text("Select Weapon First")
	...
	StopTween(Auto_Dark_Coat)
		    ...
		    iain:Toggle("Auto Dark Coat Hop",_G.Setting_table.Auto_Dark_Coat,function(vu)
   Auto_Dark_Coat = vu
...
local L_C = iain:Label("Chest : "..C_H_H.."/".._G.Setting_table.Chest_Lock)
...
spawn(function()
    ...
    iain:Slider("Chest Lock",1,100,_G.Setting_table.Chest_Lock,function(vu)
...
spawn(function()
    ...
    iain:Seperator("Others")
    
    iain:Toggle("Auto Musketeer Hat",_G.AutoMusketeerHat,function(value)
    ...
    iain:Toggle("Auto Rainbow Haki",_G.Auto_Rainbow_Haki,function(value)
    ...
    iain:Toggle("Auto Observation Haki v2",_G.AutoObservationv2,function(value)
    ...
    iain:Toggle("Auto Rengoku",_G.AutoRengoku,function(value)
            ...
            while wait() do
                if _G.AutoEctoplasm then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Ship Deckhand [Lv. 1250]") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Engineer [Lv. 1275]") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Steward [Lv. 1300]") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Officer [Lv. 1325]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if "Ship Deckhand [Lv. 1250]" or "Ship Engineer [Lv. 1275]" or "Ship Steward [Lv. 1300]" or "Ship Officer [Lv. 1325]" then
                                repeat task.wait()
                                    EquipWeapon(_G.SelectWeapon)
                                    AutoHaki()
                                    if "Ship Deckhand [Lv. 1250]" or "Ship Engineer [Lv. 1275]" or "Ship Steward [Lv. 1300]" or "Ship Officer [Lv. 1325]" then
                                ...
                                until _G.AutoEctoplasm == false or v.Humanoid.Health <= 0
                            end
                        end
   ...
   iain:Toggle("Auto Yama",_G.AutoYama,function(value)
        _G.AutoYama = value
    ...
    iain:Toggle("Auto Evo Race (V2)",_G.Auto_EvoRace,function(value)
    ...
    iain:Toggle("Auto Bartlio Quest",_G.AutoBartilo,function(value)
    ...
    iain:Toggle("Auto Holy Torch",_G.AutoHolyTorch,function(value)
                ...
                if _G.BringMonster then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if _G.Auto_EvoRace and StartEvoMagnet then
                            if v.Name == "Swan Pirate [Lv. 775]" and (v.HumanoidRootPart.Position - PosMonEvo.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
...
spawn(function()
                ...
                pcall(function()
                    ...
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Bird-Bird: Phoenix") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird-Bird: Phoenix") then
                        _G.SelectChip = "Bird: Phoenix"
						 elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dough-Dough") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird-Bird: Phoenix") then
                        _G.SelectChip = "Dough"
                    else
                        _G.SelectChip = "Flame"
                    end
    ...
    D:Toggle("Auto Drop Fruit",_G.DropFruit,function(value)
        _G.DropFruit = value
            ...
            D:Toggle("Take a random fruit from the inventory",_G.Setting_table.Get_Fruit,function(value)
...
Misc:Button("Color Haki",function()
    ...
    Misc:Button("Unlock FPS",function()
     ...
     Misc:Button("Fake Skin MODEÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¾ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¦ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¾ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¾Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â¦ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬ ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã¢â‚¬Â¦Ãƒâ€šÃ‚Â¡ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¢",function()
	 spawn(function()
     pcall(function()
     while true do
     wait(.0)
